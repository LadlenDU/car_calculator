 ...
 * Description: Отправляет заявку на расчет цена на автомобили.
 * Version: 1.0
 */
...
{
    add_options_page('Настройки калькулятора автомобилей', 'Калькулятор автомобилей', 'manage_options', 'windows_calculator', 'plugin_options_page');
}
