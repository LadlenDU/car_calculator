...
?>
<script>
    var wndSelVariables = <?php echo json_encode($CarCalc->options) ?>;
    ...
    <div class="wnd_calc_container_tr">
        <div class="wnd_calc_select_wrapper">
            <div class="wnd_calc_window_type">
                ...
                <div class="wnd_calc_window_type_select"><?php echo $CarCalc->windowSelect ?></div>
            </div>
            <div class="wnd_calc_characteristics">
                <div class="wnd_calc_capt">Характеристики</div>
                <div class="wnd_calc_characteristic"><?php echo $CarCalc->commonSelect ?></div>
            </div>
        </div>
